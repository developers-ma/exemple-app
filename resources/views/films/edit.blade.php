<x-app-layout>
    <div class="films-content" >
                ...
                <h1 class="films-page-title" style="font-size:30px">
                    ...
                    <input style="width: 100%; max-width: 600px;border: 1px solid #4CAF50;" type="text" class="form-control" id="title" name="title" value="{{ $film->title }}" placeholder="Le Nom du film" required>
                    ...
                    <div>
                        <div>
                            <div class="film-frame" style="max-width: 700px!important;">
                                ...
                                <input type="text" class="form-control" id="image_url" name="image_url" value="{{ $film->image_url }}">
                                ...
                                <div style="position: relative; margin: 14px;">
                                    ...
                                    <input type="text" class="form-control" style="width: 100%; max-width: 600px;border: 1px solid #4CAF50;" id="image_url" name="image_url" value="{{ $film->image_url }}" placeholder="L'URL de l'image" required>
