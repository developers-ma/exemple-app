...
<script>
    document.addEventListener('DOMContentLoaded', function () {
      ...
      var table = $('#films-table').DataTable({
        ...
        var dataTable = $('#films-table').DataTable();

        // Find the input element within the filter div and set its placeholder attribute
        $('#films-table_filter input').attr('placeholder', 'Recherchez un film');
        
        // Add a search icon before the input element
        $('#films-table_filter label').prepend('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style="position: absolute; width: 20px; margin-left: 12px; margin-top: 8px;"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z"/></svg>');

            // Remove the text "Search:" by finding the label element and removing its contents
            $('#films-table_filter label').contents().filter(function() {
